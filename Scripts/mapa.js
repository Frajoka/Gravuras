	...
	for(var i=0;i<tamanhoY;i++){
		for(var j=0;j<tamanhoX;j++){
			...
			j<tamanhoX-1 && i<tamanhoY-1 && Math.random()<=noiseMap[i][j]){
				...
				Mapa.push(new Block('Planta',j,i,1,false,pegaPlanta,'https://static.wikia.nocookie.net/minecraft/images/5/5f/Tall_grassZ.gif/revision/latest?cb=20190329133252'))
				plantas.push(
